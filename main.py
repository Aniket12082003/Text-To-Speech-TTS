...
#icon
image_icon = PhotoImage(file="speaking.png")
...
btn = Button(root,text="Speak",compound=LEFT,image=imageicon,width=140,font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)

imageicon2 = PhotoImage(file="download.png")
save = Button(root,text="Save",compound=LEFT,image=imageicon2,width=140,bg="#39c790",font="arial 14 bold",command=download)
